...
int main( int argc, char **argv )
{
  ...
  by_last_name = createTable( performance, CAPACITY, &hash_last_name, comp_last_name );

  by_first_name = createTable( performance, CAPACITY, &hash_first_name, comp_first_name );
  for (i=0;i<TOTAL_RECORDS;i++)
  {
